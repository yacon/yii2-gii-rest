...
namespace yacon\gii\generators\crud;
...
{
    public $routeFile = 'frontend/config/route.php';
    public $modelClass;
    public $controllerClass;
    public $baseControllerClass = 'app\modules\api\components\ActiveController';
    public $searchModelClass = '';
    public $usePluralize = true;
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'usePluralize' => 'open api spec paths 用复数命名格式',
        ]);
    }
    ...
    public function generate()
    {
        ...
        $routeFile = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->routeFile, '\\')));
        $modelFile = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->modelClass, '\\')) . '.php');
        $controllerFile = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->controllerClass, '\\')) . '.php');

        return [
            new CodeFile($routeFile, $this->render('rules.php')),
