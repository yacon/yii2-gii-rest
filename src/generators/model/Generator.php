...
namespace yacon\gii\generators\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db';
    public $ns = 'app\modules\api\models';
    public $tableName;
    public $modelClass;
    ...
    public $queryNs = 'app\modules\api\models';
    public $queryClass;
     ...
     */
    protected
    function generateRelationLink($refs)
    {
        $pairs = [];
        foreach ($refs as $a => $b) {
            $pairs[] = "'$a' => '$b'";
